...
class Infer_CU:
    ...
    def inference_axial_from_coronal(self, args):
        ...
        for step, data in data_loader:
            ...
            FOV = torch.zeros_like(data_0).unsqueeze(dim=0)
            axi_recons = self.eval_output_transform(axi_outputs, FOV, extra_params)
