...
class Infer_CU:
    ...
    def inference_axial_from_coronal(self, args):
        ...
        for step, data in data_loader:
            ...
            save_fdir_cor = save_fdir_upper / 'recon_cor'
            save_fdir_cor.mkdir(exist_ok=True)
            save_fdir_sag = save_fdir_upper / 'recon_sag'
            ...
            save_fdir_cor_specimen = save_fdir_cor_type / specimen_fname
            save_fdir_cor_specimen.mkdir(exist_ok=True)
            save_fdir_sag_specimen = save_fdir_sag_type / specimen_fname
            save_fdir_sag_specimen.mkdir(exist_ok=True)
            ...
            save_cor_fname = str(save_fdir_cor_specimen) + '/' + fname + '.mat'
            ...
            save_sag_fname = str(save_fdir_sag_specimen) + '/' + fname + '.mat'
