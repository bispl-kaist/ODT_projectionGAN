...
class ModelTrainerIMGgan:
    ...
    def _train_step_G(self, img_down, img_full, extra_params):
        ...
        pred_cfc = self.modelD_Full(outputs_full_cfc)
        ...
        pred_fcf = self.modelD_Down(outputs_down_fcf)
    ...
    def _train_step_D_double(self, img_full, outputs_full_cfc, img_down, outputs_down_fcf):
        ...
        # D Full
        # Real
        pred_real_full = self.modelD_Full(img_full)
        ...
        pred_fake_full = self.modelD_Full(outputs_full_cfc)
        ...
        # D Down
        # Real
        pred_real_down = self.modelD_Down(img_down)
        ...
        pred_fake_down = self.modelD_Down(outputs_down_fcf)
